...
- Rob T., Cameron G., & Cyrus K. 2023-10-09 (spatial and quality of life updates)
...
# Decide if running a RPi version
...
# Standardizes "Please click" instruction to be at the center of the screen every time
guidetext= canvas_1.create_text(512, 300,
...
def all_systems_go():
    print("All systems go! :D")
    if random.random() < 0.01:
        print("- YOU HAVE BEEN CHOSEN AS THE NEXT LEAD RA. CONTACT AUTHORITIES IMMEDIATELY.")
    if operant_box_version:
